  ...
  return (
    <section className="bg-black h-[100vh] max-h-[100%] lg:py-16 py-32">
      ...
      <div className="wrapper flex flex-col mx-11 lg:flex-row gap-12 lg:p-20">
        ...
        <div className="single2 flex-initial lg:w-[48rem] lg:opacity-70 relative">
        ...
        <div className="flex-initial lg:w-[60rem] rounded-[30px] bg-[#111] p-10">
          ...
          <div className="lg:mt-2 lg:p-10 p-2">
            <p className="lg:text-[0.98rem] text-[0.98rem] opacity-50 text-white lg:leading-8">
          ...
          <div className="grid lg:grid-cols-4 grid-cols-2  p-10 justify-between lg:gap-0 gap-12">
            <span className="lg:text-4xl text-2xl font-extrabold text-white flex flex-col opacity-80">
              500
            ...
            <span className="lg:-4xl text-2xl font-extrabold text-white flex flex-col  opacity-80">
              300
              <small className="text-[0.892rem]  text-white leading-[2rem]">
                concert picture
              </small>
            </span>
          </div>
          <button className="lg:px-12 lg:py-4 px-2 py-2 bg-white opacity-80 rounded-full">
