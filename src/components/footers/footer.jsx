    ...
    <section className="flex flex-wrap items-center justify-around">
      <div className="grid grid-cols-2  place-content-center items-center text-white p-4">
        <span className="text-md text-white ">
          <small className="lg:text-[1.2rem] text-white opacity-50">Mail:</small>
          <i className="lg:text-1xl text-sm text-white opacity-100 ml-2">
            Christina@gmail.com
          </i>
        </span>
        <span>
          <small className="lg:text-[1.1rem] text-white opacity-50 ml-2">
            Phone:
          </small>
